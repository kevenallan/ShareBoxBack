...
public class ArquivoController {
    ...
    public ResponseEntity<ResponseModel<?>> updateFile(@RequestParam("file") MultipartFile file,
            @RequestParam("nome") String nomeArquivo, @RequestParam("nomeArquivoAntigo") String nomeArquivoAntigo) throws InterruptedException, ExecutionException, FileNotFoundException, IOException {
